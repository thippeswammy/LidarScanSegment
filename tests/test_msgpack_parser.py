...
def test_parse_sample_msgpack(sample_file):
    ...
    assert scan_2["Rssi"][0] == pytest.approx(
        [44432, 44432, 44432, 44432, 44432, 44432, 44432, 44432, 44432, 44432])
    assert scan_2["Rssi"][1] == pytest.approx(
        [44432, 44432, 44432, 44432, 44432, 44432, 44432, 44432, 44432, 44432])

    assert len(scan_2["Distance"]) == 2
    assert scan_2["Distance"][0] == pytest.approx(
        [456.123, 456.123, 456.123, 456.123, 456.123, 456.123, 456.123, 456.123, 456.123, 456.123])
    assert scan_2["Distance"][1] == pytest.approx(
        [456.123, 456.123, 456.123, 456.123, 456.123, 456.123, 456.123, 456.123, 456.123, 456.123])
